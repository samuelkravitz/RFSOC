...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TLAST_GEN is
  ...
  attribute SOFT_HLUTNM of m00_axis_tlast_reg_i_8 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of m00_axis_tlast_reg_i_9 : label is "soft_lutpair0";
...
\def_counter_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => m00_axis_tlast_reg_i_2_n_0,
      D => \def_counter_reg[0]_i_1_n_15\,
      Q => def_counter_reg(0),
      R => m00_axis_tlast_reg_i_1_n_0
    );
...
m00_axis_tlast_reg_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
m00_axis_tlast_reg_i_11: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
m00_axis_tlast_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
m00_axis_tlast_reg_i_6: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => def_counter_reg(7),
      I4 => m00_axis_tlast_reg_i_10_n_0,
      I5 => m00_axis_tlast_reg_i_11_n_0,
...
m00_axis_tlast_reg_i_9: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
