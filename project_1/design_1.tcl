...
user.org:user:TLAST_GEN:1.0\
xilinx.com:ip:clk_wiz:6.0\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:axis_data_fifo:2.0\
xilinx.com:ip:smartconnect:1.0\
xilinx.com:ip:fir_compiler:7.2\
user.org:user:split_square_sum:1.0\
"
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.mADC_Sampling_Rate {1.47456} \
    CONFIG.mADC_Slice00_Enable {true} \
  ] $usp_rf_data_converter_0


  # Create instance: TLAST_GEN_0, and set properties
  set TLAST_GEN_0 [ create_bd_cell -type ip -vlnv user.org:user:TLAST_GEN:1.0 TLAST_GEN_0 ]
...
-14,   -15,   -15,   -15,   -16,   -16,   -16,   -16,   -17,   -17,   -17,   -17,   -17,   -17,   -17,   -17,   -17,   -17,   -17,   -17,   -17,   -16,   -16,   -16,   -16,   -16,   -15,   -15,   -15,\
  ...
  # Create instance: split_square_sum_0, and set properties
  set split_square_sum_0 [ create_bd_cell -type ip -vlnv user.org:user:split_square_sum:1.0 split_square_sum_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net TLAST_GEN_0_M00_AXIS [get_bd_intf_pins TLAST_GEN_0/M00_AXIS] [get_bd_intf_pins split_square_sum_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net split_square_sum_0_M00_AXIS [get_bd_intf_pins split_square_sum_0/M00_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
